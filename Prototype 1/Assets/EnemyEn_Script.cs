...
public class EnemyEn_Script : MonoBehaviour
{
    ...
    //public Exsample playerScript;
    //public EStar enemyScript;
    ...
    void Start()
    {
        ...
        i = 1;
        //ONOFF_player = playerScript.GetONOFF_count();
        //ONOFF_enemy = enemyScript.GetONOFF_count();
        //Debug.Log(ONOFF_player); //5
        //Debug.Log(ONOFF_enemy); //0
    }
